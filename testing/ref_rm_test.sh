...
print_pwd;  
2041 tigger-rm a ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
...
print_pwd;  
2041 tigger-rm --cached a ; echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
...
print_pwd;  
2041 tigger-rm --force a ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
...
print_pwd;  
2041 tigger-rm --force --cached a ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
...
echo fff > a
print_pwd;  
2041 tigger-rm a b ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
...
echo "[no options]"; echo "initial"
print_pwd;  
2041 tigger-rm a b c d e f g h i j ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
...
echo "[no options]"; echo "initial"
print_pwd;  
2041 tigger-rm --force g h i c f j d e a b   ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
...
echo "[no options]"; echo "initial"
print_pwd;  
2041 tigger-rm --cached g h i c f j d e a b   ;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
...
echo "[no options]"; echo "initial"
print_pwd;  
2041 tigger-rm  e f x g y h z i s j k;echo "Exit status: $?";echo "after 2041 tigger-rm"
print_pwd;  
close_tigger
